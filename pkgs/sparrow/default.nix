...
let
  ...
  src = fetchurl {
    ...
    hash = "sha256-pam+VQ3bwyKH0AgiyAkCETX5NoAflcT64cSB/qFu5Rs=";
  ...
  manifest = fetchurl {
    ...
    hash = "sha256-7LXKobeuMOyLJ6N4uJLmbgMx+ZmgKirWs+NmjpgEGxc=";
  };
  ...
  manifestSignature = fetchurl {
    ...
    hash = "sha256-l+xFN/GG2GKJTmVR86OgbXmjmMEk6fOyAuSnH7G5mCI=";
  };
